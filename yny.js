//1-Y sequence: mountain and expansion.
//Adapted from YNySequence by Naruyoko, https://naruyoko.github.io/googology/YNySequence/
//(used with the author's own permission, see THIRD-PARTY.md).
//Y sequence by Yukito.
//Changes: wrapped in a module object; the page UI (form handling, url state,
//window.onload, window.onerror) is removed. The algorithm is unchanged.
var YNy=(function (){
...
return {calcMountain:calcMountain,calcDiagonal:calcDiagonal,getBadRoot:getBadRoot,expand:expand};
})();
if(typeof module!=="undefined")module.exports=YNy;
